...
// Conteúdo de todos os capítulos (módulos importados de arquivos separados)
const CHAPTER_CONTENT = {
  ...
  'html-03': {
    ...
    desc: 'Todo site começa aqui. Entenda o que cada linha da estrutura mínima faz e por que ela existe.',
    blocks: [
      { type:'text', title:'Por que toda página começa igual?',
        body:'Quando o navegador abre um arquivo HTML, ele precisa saber que tipo de documento é aquele e qual idioma ele usa. A estrutura base responde isso antes de mostrar qualquer conteúdo visível.' },
      { type:'callout',
        body:'<strong>Dica:</strong> Você nunca precisa memorizar essa estrutura. Em qualquer editor, digitar <code>!</code> e apertar <code>Tab</code> gera tudo automaticamente. O importante é entender o que cada parte faz.' },
      { type:'text', title:'O que cada linha significa',
        body:'O <code>&lt;!DOCTYPE html&gt;</code> diz ao navegador que usamos HTML5. O <code>lang="pt-BR"</code> define o idioma — ajuda leitores de tela e ferramentas de tradução. No <code>&lt;head&gt;</code> ficam informações que o browser lê mas o usuário não vê. O <code>&lt;body&gt;</code> é onde vive tudo que aparece na tela.' },
    ],
    editor: {
      tabs: ['HTML'],
      code: [`<!DOCTYPE html>
<html lang="pt-BR">
  ...
  <body>
    <h1>Olá, mundo!</h1>
    <p>Edite este código e veja o resultado →</p>
  </body>
</html>`],
    },
    quiz: [
      { q:'Qual tag define o início do conteúdo visível de uma página HTML?',
        opts:['<head>','<html>','<body>','<meta>'], correct:2,
        explanation:'O <body> contém tudo que é exibido na tela: textos, imagens, botões etc.' },
      { q:'Para que serve o atributo lang="pt-BR" na tag <html>?',
        opts:['Definir a fonte do site','Indicar o idioma da página','Conectar ao servidor','Aplicar estilos CSS'], correct:1,
        explanation:'O atributo lang indica o idioma do documento, auxiliando leitores de tela e ferramentas de acessibilidade.' },
      { q:'O que o <!DOCTYPE html> informa ao navegador?',
        opts:['Qual CSS usar','Qual versão do HTML está sendo usada','O título da página','O charset do arquivo'], correct:1,
        explanation:'O DOCTYPE html diz ao navegador que o documento usa HTML5, o padrão moderno.' },
    ],
    challenge: {
      title:'Crie a estrutura da sua página de perfil',
      desc:'Monte a estrutura base de uma página de perfil pessoal usando o editor acima.',
      tasks:[
        'Escreva o DOCTYPE correto e defina lang como pt-BR',
        'Adicione um <title> com seu nome',
        'Coloque um <h1> com seu nome no body',
        'Adicione um <p> com uma frase sobre você',
        'Inclua a meta viewport para responsividade',
      ],
    },
  },
  ...
  'ai-02': {
    ...
    desc: 'A diferença entre uma resposta inútil e uma perfeita geralmente está na qualidade da pergunta.',
    blocks: [
      { type:'text', title:'Por que a maioria dos prompts falha?',
        body:'A IA não lê a sua mente. Quando você escreve "me ajuda com esse código", ela não sabe qual código, qual problema, qual linguagem ou o que você espera receber. Contexto é tudo.' },
      { type:'callout',
        body:'<strong>Regra de ouro:</strong> Um bom prompt tem 4 ingredientes — <strong>Contexto</strong> (quem você é, o que está fazendo), <strong>Instrução</strong> (o que quer), <strong>Formato</strong> (como quer a resposta) e <strong>Exemplo</strong> (quando ajudar).' },
      { type:'text', title:'Prompt ruim vs. prompt bom',
        body:'Veja no editor a diferença na prática. O prompt ruim é vago e vai gerar resposta genérica. O bom tem contexto, instrução clara e formato definido — a resposta será muito mais útil.' },
    ],
    editor: {
      tabs: ['Prompt Ruim ❌', 'Prompt Bom ✅'],
      code: [
`<!-- PROMPT RUIM -->
...
<!-- Problemas:
  - Não diz O QUE em JavaScript
  - Não diz qual é o erro ou dúvida
  - Não diz o nível de quem pergunta
  - Não diz o formato de resposta
-->`,
`<!-- PROMPT BOM -->

Contexto: Sou estudante de ADS,
aprendendo JavaScript do zero.

Dúvida: Não entendo a diferença entre
let, const e var. Quando usar cada um?

Formato desejado:
- Explicação simples, sem jargões
- Um exemplo de código para cada
- Uma regra prática fácil de lembrar

Obs: Já li a documentação mas ficou
confuso com o escopo.`],
    },
    quiz: [
      { q:'Qual dos elementos abaixo é essencial em um bom prompt?',
        opts:['Usar emojis','Contexto sobre quem pergunta e o que quer','Escrever em inglês','Ser o mais curto possível'], correct:1,
        explanation:'O contexto é o elemento mais importante — sem saber quem pergunta e o que quer, a IA dá respostas genéricas.' },
      { q:'O que é "formato desejado" em um prompt?',
        opts:['A linguagem de programação','Como você quer que a resposta seja estruturada','O tema do prompt','O número de palavras'], correct:1,
        explanation:'Especificar o formato (lista, código, explicação simples etc.) ajuda a IA a entregar exatamente o que você precisa.' },
      { q:'Por que prompts vagos geram respostas ruins?',
        opts:['A IA fica com preguiça','A IA não tem como inferir contexto que não foi fornecido','A IA não entende português vago','Prompts curtos são bloqueados'], correct:1,
        explanation:'A IA só trabalha com o que você fornece. Sem contexto e instrução claros, ela preenche lacunas com suposições genéricas.' },
    ],
    challenge: {
      title:'Escreva 3 prompts reais',
      desc:'Pense em 3 dúvidas reais de programação e escreva um prompt bem estruturado para cada uma.',
      tasks:[
        'Escreva um prompt sobre uma dúvida de HTML com contexto',
        'Escreva um prompt pedindo para debugar um erro específico',
        'Escreva um prompt pedindo explicação de um conceito',
        'Cada prompt deve ter Contexto + Instrução + Formato',
      ],
    },
  },
};
